...
void R_InitTextures(void)
{
    ...
    texturecolumnlump = (short int **)Z_Malloc(numtextures * sizeof(*texturecolumnlump), PU_STATIC, 0);
    texturecolumnofs = (short unsigned int **)Z_Malloc(numtextures * sizeof(*texturecolumnofs), PU_STATIC, 0);
    ...
    for (i = 0; i < numtextures; i++, directory++)
    {
        ...
        texture = textures[i] = (texture_t *)Z_Malloc(sizeof(texture_t) + sizeof(texpatch_t) * (SHORT(mtexture->patchcount) - 1),
                                                      PU_STATIC, 0);
